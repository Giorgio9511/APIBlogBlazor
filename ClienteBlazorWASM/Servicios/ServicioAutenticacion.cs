...
namespace ClienteBlazorWASM.Servicios
{
    public class ServicioAutenticacion : IServicioAutenticacion
    {
        ...
        public async Task<RespuestaAutenticacion> Acceder(UsuarioAutenticacion usuarioParaAutenticar)
        {
            var content = JsonConvert.SerializeObject(usuarioParaAutenticar);
